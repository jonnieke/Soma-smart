...
export const CampusPage: React.FC = () => {
    return (
        <>
            <Helmet>
                <html lang="en" />
                <title>Campus Hub | University &amp; College Study Tools Kenya — Soma AI</title>
                ...
                <meta name="keywords" content="Kenyan university study assistant, college PDF summarizer, research paper feedback Kenya, Soma AI campus hub" />
                ...
                <meta property="og:title" content="Campus Hub | University &amp; College Study Tools — Soma AI" />
