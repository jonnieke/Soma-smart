...
export const generateTeachingStrategies = async (
    ...
    const prompt = `
    You are the Soma AI Admin Agent — a meta-teaching strategist for the Kenyan education system.
    
    SYSTEM CONTEXT: Soma AI is an AI tutoring platform serving Kenyan students (CBC Grades 1-9 and 8-4-4 Forms 1-4).
