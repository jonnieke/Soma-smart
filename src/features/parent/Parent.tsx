                    ...
                    <div className="mt-4 flex flex-col sm:flex-row gap-3">
                        <a
                            href={`https://wa.me/?text=${encodeURIComponent([
                                ...
                                `Quizzes done: ${proofStats.quizzes}`,
                                `Recall breaks: ${proofStats.activeRecallBreaks}`,
                                `Mistakes fixed: ${proofStats.repairedQuestions}`,
                                `Next step: ${proofStats.nextAction}`,
                                'https://somaai.co.ke'
                            ].join('\n'))}`}
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center justify-center gap-2 rounded-2xl bg-[#25D366] text-white px-5 py-3 text-xs font-black uppercase tracking-wider hover:bg-[#128C7E] transition-colors"
                        >
                        ...
                        <button
                            onClick={shareWeeklyProof}
                            className="flex items-center justify-center gap-2 rounded-2xl bg-slate-900 dark:bg-white text-white dark:text-slate-950 px-5 py-3 text-xs font-black uppercase tracking-wider hover:opacity-90 transition-opacity"
                        >
