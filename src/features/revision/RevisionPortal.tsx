            ...
            <main className="mx-auto max-w-6xl space-y-20 px-4 py-10 sm:px-8 sm:py-16">
                <section className="text-center">
                    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="mx-auto max-w-4xl space-y-6">
                        ...
                        <h1 className="text-5xl font-black leading-[1.05] tracking-tight sm:text-7xl">Published papers first.<br /><span className="bg-gradient-to-r from-orange-500 to-rose-500 bg-clip-text text-transparent">Open one and start improving.</span></h1>
                        <p className="mx-auto max-w-2xl text-lg font-medium leading-relaxed text-slate-600 dark:text-slate-300">Choose a real paper, open it fast, and use marks and feedback to recover weak areas before exam day.</p>
