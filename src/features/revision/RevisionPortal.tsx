            ...
            <main className="mx-auto max-w-6xl space-y-20 px-4 py-10 sm:px-8 sm:py-16">
                <section className="text-center">
                    <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="mx-auto max-w-4xl space-y-6">
                        ...
                        <button onClick={openExamLibrary} className="inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-orange-500 to-rose-600 px-8 py-4 text-lg font-black text-white shadow-xl shadow-orange-500/20">{isRegistered ? 'Start with first paper' : 'Start free'} <ArrowRight className="h-5 w-5" /></button>
