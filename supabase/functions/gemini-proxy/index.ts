...
const MAX_OUTPUT_TOKENS_FREE = Math.max(1200, Number(Deno.env.get('MAX_OUTPUT_TOKENS_FREE') || '1200'));
const MAX_OUTPUT_TOKENS_PAID = Math.max(3000, Number(Deno.env.get('MAX_OUTPUT_TOKENS_PAID') || '3000'));
